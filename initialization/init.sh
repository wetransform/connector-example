...
CUSTOM_NAMESPACE_PREFIX='edc' # default to edc
# TODO: As soon as available in the frontend, uncomment the next two lines:
#CUSTOM_NAMESPACE_PREFIX="ingeo-x"
#CUSTOM_NAMESPACE="http://example.com/ingeo-x/"
WETRANSFORM_ROLE_CONSTRAINT_KEY="${CUSTOM_NAMESPACE}wetransformRole"
GEOFENCE_RESTRICTION_CONSTRAINT_KEY="${CUSTOM_NAMESPACE}geofenceRestriction";
GEOFENCE_FILTER_DUTY_KEY="${CUSTOM_NAMESPACE}geofenceFilter"

if [[ -n "$CUSTOM_NAMESPACE" ]]; then
  CUSTOM_NAMESPACE_CODE=',"'"$CUSTOM_NAMESPACE_PREFIX"'": "'"$CUSTOM_NAMESPACE"'"'
else
...
create_policy() {
    ...
    response=$(curl -s -o /dev/null -w "%{http_code}" -X POST "$EDC_BASE_URL/management/v3/policydefinitions" \
                ...
                "odrl:constraint": [
                    {
                        ...
                        "odrl:leftOperand": {
                            "@id": "'"$CUSTOM_NAMESPACE_PREFIX"':wetransformRole"
                        },
                        "odrl:operator": {
                            "@id": "odrl:eq"
                        },
                ...
                "odrl:constraint": [
                    {
                        "@type": "AtomicConstraint",
                        "odrl:leftOperand": {
                            "@id": "'"$CUSTOM_NAMESPACE_PREFIX"':geofenceRestriction"
                        },
                        "odrl:operator": {
                            "@id": "odrl:isPartOf"
                        },
      ...
      "@context": {
        ...
        "odrl": "http://www.w3.org/ns/odrl/2/"'"$CUSTOM_NAMESPACE_CODE"'
      }
    }')
                ...
                "odrl:constraint": [
                    {
                        "@type": "AtomicConstraint",
                        "odrl:leftOperand": {
                            "@id": "'"$CUSTOM_NAMESPACE_PREFIX"':geofenceFilter"
                        },
                        "odrl:operator": {
                            "@id": "odrl:isPartOf"
                        },
...
POLICY_PARAM_1_3="forest-data-holder"
POLICY_PARAM_2_3="POLYGON((136.98507556190478 -21.493172818177026,129.51437243690478 -29.113032921614074,144.27999743690478 -35.71014778169594,149.28976306190478 -26.86252248905155,136.98507556190478 -21.493172818177026))"
...
ASSET_ACTIVE_4=true
CREATE_POLICY_4=create_filter_policy # create_policy_norestriction
...
while [ "$i" -le "$ASSET_COUNT" ]; do
    ...
    PARAM_1=$(eval echo "\$POLICY_PARAM_1_$i")
    PARAM_2=$(eval echo "\$POLICY_PARAM_2_$i")
    ...
    eval "\$CREATE_POLICY_$i \"\$POLICY_ID\" \"\$POLICY_NAME\" \"\$PARAM_1\" \"\$PARAM_2\""
